...
then
                        ...
                        sleep 2
			# Verschiebt alle Dateien aus der alten Woche in den "/backup/old_backup" Ordner
			...
			#Zählen der Dateien im "/backup/old_backup" Ordner
			...
			#Wenn mehr als 7 Dateien vorhanden sind
					...
					# Wird erst ab der 3. Woche ausgelöst
							...
							#Filtert nach der ältesten Datei im Ordner un löscht diese
